...
var ParamsFieldsDeserializer = require('../deserializers/params-fields'); // NOTICE: Prevent bad date formatting into timestamps.
...
function CSVExporter(params, response, modelName, recordsExporter) {
  this.perform = function () {
    ...
    response.setHeader('Last-Modified', moment()); // NOTICE: From nginx doc: Setting this to "no" will allow unbuffered
